...
namespace afterlife_caretakers.Models
{
    public class ConsultProfile
    {
        ...
        [Required(ErrorMessage = "Please enter your charging rate per hour."), Range(0,50, ErrorMessage ="Highest rate allowed is $50/hr")]
        ...
        [Required(ErrorMessage = "A description / write - up(100 characters minimum) of yourself is needed."), MinLength(1, ErrorMessage = "A description/write-up(100 characters minimum) of yourself is needed.")]
