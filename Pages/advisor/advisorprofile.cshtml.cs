...
{
    public class advisorprofileModel : PageModel
    {
        ...
        public advisorprofileModel(ILogger<teamadvisorsModel> logger, ConsultService service)
        {
            _logger = logger;
            _svc = service;
        }
        public IActionResult OnGet(int id)
        {
            ...
            {
                return RedirectToPage("/advisor/teamadvisors");
            }
        }
    }
}
