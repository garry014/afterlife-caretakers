...
{
    public class Register_WitnessModel : PageModel
    {
        private readonly Services.UserService _svc;

        public Register_WitnessModel(Services.UserService service, IWebHostEnvironment hostEnvironment)
        {
            _svc = service;
