...
{
    public class viewmyapptModel : PageModel
    {
        [BindProperty]
        ...
        [BindProperty]
        public List<Users> userall { get; set; }
        ...
        public viewmyapptModel(Services.ConsultService service, Services.BookingService bservice, Services.UserService uservice)
        {
            _svc = service;
            _bsvc = bservice;
            _usvc = uservice;
        ...
        {
            //HttpContext.Session.SetInt32("user_id", 3003);
            ...
            //int custid = 0;
            //custid = (int)HttpContext.Session.GetInt32("user_id");
